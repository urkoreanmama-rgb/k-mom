      ...
      <section className="px-6 py-24 sm:py-32 lg:py-40 max-w-5xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            ...
            className="inline-flex h-12 items-center rounded-full bg-zinc-900 px-7 text-sm font-medium text-white hover:bg-zinc-700 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            업주 등록
          </Link>
          <Link
            href="/signup?role=student"
            className="inline-flex h-12 items-center rounded-full border border-zinc-300 px-7 text-sm font-medium hover:border-zinc-400 dark:border-zinc-700 dark:hover:border-zinc-600"
          >
            학생 등록
          </Link>
        </div>
      ...
      <section className="bg-zinc-50 dark:bg-zinc-950">
        <div className="px-6 py-20 max-w-5xl mx-auto text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex h-12 items-center rounded-full bg-zinc-900 px-7 text-sm font-medium text-white hover:bg-zinc-700 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
            비자 체커 열기 →
          </a>
        </div>
